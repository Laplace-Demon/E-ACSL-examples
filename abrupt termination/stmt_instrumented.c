      ...
      */
      {
        ...
        if (x % 5 == 0) {
          __retres = x;
          {
            ...
            if (x % 5 == 0) {
              __e_acsl_assert_register_int(& __gen_e_acsl_assert_data,"x",0,
                                           x);
              __gen_e_acsl_and = (int)((x + 1L) % 7L) != 0;
            }
            else __gen_e_acsl_and = 0;
            if (__gen_e_acsl_and) {
              __e_acsl_assert_register_int(& __gen_e_acsl_assert_data,"x",0,
                                           x);
              __gen_e_acsl_and_2 = (int)((x + 2L) % 11L) != 0;
            }
            ...
            if (__gen_e_acsl_and_2) {
              ...
              __e_acsl_assert_register_int(& __gen_e_acsl_assert_data,"x",0,
                                           x);
              __gen_e_acsl_and_3 = x == x;
            }
            else __gen_e_acsl_and_3 = 0;
            __gen_e_acsl_assert_data.blocking = 1;
            __gen_e_acsl_assert_data.kind = "Assertion";
            __gen_e_acsl_assert_data.pred_txt = "x % 5 \342\211\241 0 \342\210\247 (x + 1) % 7 \342\211\242 0 \342\210\247 (x + 2) % 11 \342\211\242 0 \342\210\247 x \342\211\241 x";
            __gen_e_acsl_assert_data.file = "stmt.c";
      ...
      if ((int)((x + 1L) % 5L) != 0) {
        __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_2,"x",0,x);
        __gen_e_acsl_and_4 = (int)((x + 2L) % 7L) != 0;
      }
      else __gen_e_acsl_and_4 = 0;
      if (__gen_e_acsl_and_4) {
        __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_2,"x",0,x);
        __gen_e_acsl_and_5 = (int)((x + 3L) % 11L) != 0;
      }
      else __gen_e_acsl_and_5 = 0;
      if (__gen_e_acsl_and_5) {
        __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_2,"x",0,x);
        __e_acsl_assert_register_long(& __gen_e_acsl_assert_data_2,
                                      "\\old(x)",0,__gen_e_acsl_at);
        __gen_e_acsl_and_6 = (long)x == __gen_e_acsl_at - 3L;
      }
      else __gen_e_acsl_and_6 = 0;
      __gen_e_acsl_assert_data_2.blocking = 1;
      __gen_e_acsl_assert_data_2.kind = "Postcondition";
      __gen_e_acsl_assert_data_2.pred_txt = "(x + 1) % 5 \342\211\242 0 \342\210\247 (x + 2) % 7 \342\211\242 0 \342\210\247 (x + 3) % 11 \342\211\242 0 \342\210\247\nx \342\211\241 \\old(x) - 3";
      __gen_e_acsl_assert_data_2.file = "stmt.c";
