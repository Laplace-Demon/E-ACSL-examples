...
int __gen_e_acsl_max(int x, int y)
{
  ...
  int __retres;
  {
    ...
    if (__gen_e_acsl_active_bhvrs != 1) {
      ...
      __gen_e_acsl_assert_data.file = "E-ACSL-examples/ACSL manual/max2.c";
      ...
      __gen_e_acsl_assert_data_2.file = "E-ACSL-examples/ACSL manual/max2.c";
  ...
  __retres = max(x,y);
  {
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_3.file = "E-ACSL-examples/ACSL manual/max2.c";
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_4.file = "E-ACSL-examples/ACSL manual/max2.c";
