...
int main(void)
{
  ...
  int n = owi_i32();
  one: __gen_e_acsl_at = n;
       ;
  owi_assume(n <= 1);
  two: ;
  {
    __e_acsl_assert_data_t __gen_e_acsl_assert_data = {.values = (void *)0};
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data,"\\at(n,one)",0,
                                 __gen_e_acsl_at);
    __gen_e_acsl_assert_data.blocking = 1;
    __gen_e_acsl_assert_data.kind = "Assertion";
    __gen_e_acsl_assert_data.pred_txt = "\\at(n,one) \342\211\244 1";
    __gen_e_acsl_assert_data.file = "at.c";
    __gen_e_acsl_assert_data.fct = "main";
    __gen_e_acsl_assert_data.line = 10;
    __e_acsl_assert(__gen_e_acsl_at <= 1,& __gen_e_acsl_assert_data);
