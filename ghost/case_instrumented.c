...
int main(void)
{
  ...
  }
  {
    ...
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data,"is_case2",0,
                                 is_case2);
    __gen_e_acsl_assert_data.blocking = 1;
    __gen_e_acsl_assert_data.kind = "Assertion";
    __gen_e_acsl_assert_data.pred_txt = "is_case2 \342\211\241 0";
    __gen_e_acsl_assert_data.file = "case.c";
    __gen_e_acsl_assert_data.fct = "main";
    __gen_e_acsl_assert_data.line = 23;
    __e_acsl_assert(is_case2 == 0,& __gen_e_acsl_assert_data);
