...
int main(void)
{
  ...
  int x = owi_i32();
  owi_assume(x >= -1);
  if (x >= 0) num = 42; else num = 0;
  {
    __e_acsl_assert_data_t __gen_e_acsl_assert_data = {.values = (void *)0};
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data,"num",0,num);
    __gen_e_acsl_assert_data.blocking = 1;
    __gen_e_acsl_assert_data.kind = "Assertion";
    __gen_e_acsl_assert_data.pred_txt = "num \342\211\241 42";
    __gen_e_acsl_assert_data.file = "if_else.c";
    __gen_e_acsl_assert_data.fct = "main";
    __gen_e_acsl_assert_data.line = 14;
    __e_acsl_assert(num == 42,& __gen_e_acsl_assert_data);
