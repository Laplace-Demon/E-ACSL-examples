...
void __gen_e_acsl_loop(int n)
{
  loop(n);
  {
    ...
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data,"cnt",0,cnt);
    __gen_e_acsl_assert_data.blocking = 1;
    __gen_e_acsl_assert_data.kind = "Postcondition";
    __gen_e_acsl_assert_data.pred_txt = "cnt > 10";
    __gen_e_acsl_assert_data.file = "global.c";
    __gen_e_acsl_assert_data.fct = "loop";
    __gen_e_acsl_assert_data.line = 5;
    __e_acsl_assert(cnt > 10,& __gen_e_acsl_assert_data);
    __e_acsl_assert_clean(& __gen_e_acsl_assert_data);
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_2 =
      {.values = (void *)0};
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_2,"cnt",0,cnt);
    __gen_e_acsl_assert_data_2.blocking = 1;
    __gen_e_acsl_assert_data_2.kind = "Postcondition";
    __gen_e_acsl_assert_data_2.pred_txt = "cnt < 20";
    __gen_e_acsl_assert_data_2.file = "global.c";
    __gen_e_acsl_assert_data_2.fct = "loop";
    __gen_e_acsl_assert_data_2.line = 6;
    __e_acsl_assert(cnt < 20,& __gen_e_acsl_assert_data_2);
