...
int __gen_e_acsl_is_dividable(int x, int y)
{
  ...
  int __retres;
  {
    ...
    __gen_e_acsl_assert_data.file = "annotated1.c";
    __gen_e_acsl_assert_data.fct = "is_dividable";
    __gen_e_acsl_assert_data.line = 4;
    __gen_e_acsl_assert_data.name = "division_by_zero";
    ...
    __gen_e_acsl_assert_data_2.file = "annotated1.c";
  ...
  __retres = is_dividable(x,y);
  {
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_3.pred_txt = "\\result \342\211\241 1";
      __gen_e_acsl_assert_data_3.file = "annotated1.c";
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_4.pred_txt = "\\result \342\211\241 0";
      __gen_e_acsl_assert_data_4.file = "annotated1.c";
      __gen_e_acsl_assert_data_4.fct = "is_dividable";
      __gen_e_acsl_assert_data_4.line = 8;
      __gen_e_acsl_assert_data_4.name = "no";
