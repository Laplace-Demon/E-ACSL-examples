...
/*@ requires size >__gen_e_acsl_assert_data_2oid *)(& ptr));
  if (ptr != (void *)0) {
    memset(ptr,0,(size_t)size);
    // __e_acsl_initialize(ptr,(size_t)size);
  }
...
/*@ assigns __e_acsl_heap_allocation_size, __e_acsl_heap_allocated_blocks;
    ...
    behavior no_deallocation:
      ...
      assigns __e_acsl_heap_allocated_blocks
        \from __e_acsl_heap_allocated_blocks;
 */
extern int ( /* missing proto */ free)(int *x_0);
...
int main(void)
{
  ...
  buffer = (int *)__gen_e_acsl_malloc_and_init(size);
  // free(buffer);
  __retres = 0;
...
/*@ requires size > 0;
    ensures
      \result ≡ \null ∨
      (∀ ℤ i; 0 ≤ i < 15 ⇒ *((int *)\result + i) ≡ 0);
 */
void *__gen_e_acsl_malloc_and_init(int size)
{
  void *__retres;
  // __e_acsl_store_block((void *)(& __retres),8UL);
  {
    ...
    __gen_e_acsl_assert_data.pred_txt = "size > 0";
    __gen_e_acsl_assert_data.file = "malloc_size.c";
    __gen_e_acsl_assert_data.fct = "malloc_and_init";
    __gen_e_acsl_assert_data.line = 5;
    __e_acsl_assume(size > 0,& __gen_e_acsl_assert_data);
    // __e_acsl_assert_clean(& __gen_e_acsl_assert_data);
  }
  __retres = malloc_and_init(size);
  {
    int __gen_e_acsl_or;
    ...
    if (__retres == (void *)0) __gen_e_acsl_or = 1;
    else {
      ...
      __gen_e_acsl_i = 0;
      while (1) {
        if (__gen_e_acsl_i < 15) ; else break;
        {
          int __gen_e_acsl_valid_read;
          __e_acsl_assert_data_t __gen_e_acsl_assert_data_3 =
            {.values = (void *)0};
          __gen_e_acsl_valid_read = 1;
          // __gen_e_acsl_valid_read = __e_acsl_valid_read((void *)((int *)__retres + __gen_e_acsl_i),
          //                                               sizeof(int),__retres,
          //                                               (void *)(& __retres));
          ...
          __gen_e_acsl_assert_data_3.pred_txt = "\\valid_read((int *)__retres + __gen_e_acsl_i)";
          __gen_e_acsl_assert_data_3.file = "malloc_size.c";
          __gen_e_acsl_assert_data_3.fct = "malloc_and_init";
...
// TODO
          ...
          if (*((int *)__retres + __gen_e_acsl_i) == 0) ;
          else {
      ...
      //                              "\342\210\200 \342\204\244 i; 0 \342\211\244 i < 15 \342\207\222 *((int *)\\result + i) \342\211\241 0",
      //                              0,__gen_e_acsl_forall);
      __gen_e_acsl_or = __gen_e_acsl_forall;
    }
    __gen_e_acsl_assert_data_2.blocking = 1;
    __gen_e_acsl_assert_data_2.kind = "Postcondition";
    __gen_e_acsl_assert_data_2.pred_txt = "\\result \342\211\241 \\null \342\210\250\n(\342\210\200 \342\204\244 i; 0 \342\211\244 i < 15 \342\207\222 *((int *)\\result + i) \342\211\241 0)";
    __gen_e_acsl_assert_data_2.file = "malloc_size.c";
    __gen_e_acsl_assert_data_2.fct = "malloc_and_init";
