...
extern int ( /* missing proto */ owi_i32)(void);
...
extern int ( /* missing proto */ owi_assert)(int x_0);
...
int __gen_e_acsl_max(int x, int y)
{
  ...
  __retres = max(x,y);
  if (x >= y) owi_assert(__retres == __gen_e_acsl_at);
  if (x <= y) owi_assert(__retres == __gen_e_acsl_at_2);
  return __retres;
}
...
int __gen_e_acsl_max(int x, int y)
{
  ...
  int __retres;
  {
    ...
    if (__gen_e_acsl_active_bhvrs != 1) {
      ...
      __gen_e_acsl_assert_data.file = "E-ACSL-examples/owi eacsl examples/max_hand_instrumented.c";
      ...
      __gen_e_acsl_assert_data_2.file = "E-ACSL-examples/owi eacsl examples/max_hand_instrumented.c";
      __gen_e_acsl_assert_data_2.fct = "max";
      __gen_e_acsl_assert_data_2.line = 1;
      __e_acsl_assert(__gen_e_acsl_active_bhvrs <= 1,
                      & __gen_e_acsl_assert_data_2);
      __e_acsl_assert_clean(& __gen_e_acsl_assert_data_2);
    }
  }
  __retres = __gen_e_acsl_max(x,y);
  {
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_3.file = "E-ACSL-examples/owi eacsl examples/max_hand_instrumented.c";
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_4.file = "E-ACSL-examples/owi eacsl examples/max_hand_instrumented.c";
