...
void __gen_e_acsl_max_ptr(int *p, int *q)
{
  ...
  int *__gen_e_acsl_at;
  {
    ...
    __gen_e_acsl_assert_data.file = "E-ACSL-examples/owi eacsl examples/max_ptr.c";
  ...
  max_ptr(p,q);
  {
    ...
    __gen_e_acsl_assert_data_3.file = "E-ACSL-examples/owi eacsl examples/max_ptr.c";
    ...
    __gen_e_acsl_assert_data_4.file = "E-ACSL-examples/owi eacsl examples/max_ptr.c";
    ...
    __gen_e_acsl_assert_data_2.file = "E-ACSL-examples/owi eacsl examples/max_ptr.c";
