...
/*@ ensures ∀ int i; 0 ≤ i < \old(size) ⇒ *(\old(buffer) + i) ≥ 0; */
void __gen_e_acsl_square_buffer(int size, int *buffer);
...
int main(void)
{
  ...
  __gen_e_acsl_square_buffer(size,buffer);
  __retres = 0;
  // __e_acsl_delete_block((void *)(& buffer));
  ...
  square_buffer(size,buffer);
  {
    ...
    while (1) {
      if (__gen_e_acsl_i < __gen_e_acsl_at) ; else break;
      {
        ...
        __gen_e_acsl_assert_data_2.file = "malloc_size_simple.c";
        __gen_e_acsl_assert_data_2.fct = "square_buffer";
        ...
        if (*(__gen_e_acsl_at_2 + __gen_e_acsl_i) >= 0) ;
        else {
    ...
    //                              "\342\210\200 int i; 0 \342\211\244 i < \\old(size) \342\207\222 *(\\old(buffer) + i) \342\211\245 0",
    //                              0,__gen_e_acsl_forall);
    __gen_e_acsl_assert_data.blocking = 1;
    __gen_e_acsl_assert_data.kind = "Postcondition";
    __gen_e_acsl_assert_data.pred_txt = "\342\210\200 int i; 0 \342\211\244 i < \\old(size) \342\207\222 *(\\old(buffer) + i) \342\211\245 0";
    __gen_e_acsl_assert_data.file = "malloc_size_simple.c";
    __gen_e_acsl_assert_data.fct = "square_buffer";
