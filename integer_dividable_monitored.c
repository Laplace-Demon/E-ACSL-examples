...
int __gen_e_acsl_is_dividable(int x, int y)
{
  ...
  int __retres;
  {
    ...
    __gen_e_acsl_assert_data.file = "integer_dividable.c";
    __gen_e_acsl_assert_data.fct = "is_dividable";
    __gen_e_acsl_assert_data.line = 3;
    __e_acsl_assume(y != 0,& __gen_e_acsl_assert_data); // Originally __e_acsl_assert
    ...
    __gen_e_acsl_assert_data_2.file = "integer_dividable.c";
    ...
    __gen_e_acsl_assert_data_3.file = "integer_dividable.c";
  ...
  __retres = is_dividable(x,y);
  {
    ...
    if (x % y == 0) {
      ...
      __gen_e_acsl_assert_data_4.file = "integer_dividable.c";
    ...
    if (x % y != 0) {
      ...
      __gen_e_acsl_assert_data_5.pred_txt = "\\result \342\211\241 0";
      __gen_e_acsl_assert_data_5.file = "integer_dividable.c";
